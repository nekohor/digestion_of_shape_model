	...
	// 凸度自学习衰减系数
       prf_vrn_lim     = 2,                    ! [mm] target profilevernier limits
                          -0.070,               !    minimum
                           0.070;               !   maximum
	// 凸度自学习极限
       prf_vrn_rm_i_gn = 0.4;                 ! [-] target profile vernier (re-predicted - measured) control loop integral gain
       prf_vrn_rm_p_gn = 0.2;                 ! [-] target profile vernier (re-predicted - measured) control loop proportional gain
	// 凸度自学习rm的PI控制系数
       prf_vrn_rs_i_gn = 0.2;                 ! [-] target profile vernier (re-predicted - setup) control loop integral gain
	// 凸度自学习rs的PI控制系数
